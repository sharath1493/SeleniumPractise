...
public class SwagLabsProductwith2ndHighPrice {
	...
	public static void main(String[] l) {
		...
		else
		{
			for(int i=0; i<p.size(); i++)
			{
				...
				else if(p.get(i) > second & max > p.get(i))
				{
					second = p.get(i);
				}
			}
		...
		int secondmaxindex =  p.indexOf(second)+1;

		System.out.println("Second highest costly item Price and Index are:"+second+ " "+secondmaxindex);

		cartxapth="("+cartxapth+")["+secondmaxindex+"]";
